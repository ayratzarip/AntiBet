...
const basicInstructions: InstructionItem[] = [
  {
    ...
    content: 'Нажмите на синюю кнопку «Новая запись» внизу главного экрана. Последовательно заполните 7 шагов: Место, Свидетели, Обстоятельства, Триггер, Мысли, Телесные ощущения, Действия. На каждом шаге есть подсказки и примеры.',
  },
  {
    id: 'edit',
    icon: 'edit',
...
const aiInstructions: InstructionItem[] = [
  {
    ...
    content: 'На главном экране нажмите кнопку "Скопировать для AI" (доступна при наличии записей). Ваши записи будут скопированы с промптом для AI. Вставьте текст в чат с ChatGPT, Claude или другим AI-помощником для анализа триггеров, паттернов и рекомендаций по работе с влечением к игре.',
  },
];
...
const securityInstructions: InstructionItem[] = [
  {
    ...
    content: 'Все записи хранятся в зашифрованном Telegram Cloud Storage. Приложение не имеет собственного сервера и не передает данные третьим лицам. Только вы имеете доступ к своим записям. Ваш дневник самонаблюдения полностью конфиденциален.',
  },
];
